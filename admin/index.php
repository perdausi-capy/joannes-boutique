...
require_once __DIR__ . '/../src/Models/Testimonial.php';
...
<body class="bg-gray-100">
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-white shadow-lg">
            ...
            <nav class="mt-4">
                <a href="/admin" class="block px-4 py-3 text-gray-700 bg-blue-50 border-r-2 border-blue-500">
                    <i class="fas fa-dashboard mr-2"></i> Dashboard
                </a>
                <a href="/admin/products.php" class="block px-4 py-3 text-gray-700 hover:bg-gray-50">
                                ...
                                <?php foreach ($recentOrders as $order): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <a href="/admin/orders.php?view=<?php echo $order['id']; ?>" 
